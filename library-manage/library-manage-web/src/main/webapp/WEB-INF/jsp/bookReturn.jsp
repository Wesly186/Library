...
<div style="padding: 10px 10px 10px 10px">
	<form id="bookReturnForm" class="returnForm" method="post">
...
<script type="text/javascript">
	...
	function submitForm() {
		//有效性验证
		if (!$('#bookReturnForm').form('validate')) {
			$.messager.alert('提示', '表单还未填写完成!');
			return;
		}
		//ajax的post方式提交表单
		$.post("/book/bookReturn.do", $("#bookReturnForm").serialize(), function(data) {
			if (data.code == 200) {
				$.messager.alert('提示', '归还图书成功!');
				clearForm();
			}else{
